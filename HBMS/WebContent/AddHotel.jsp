...
<form:form action="addHotel.htm" modelAttribute="hotelBean">
<table>

<tr>
<td>Hotel ID<font color="red">*</font>:</td><td><form:input path="hotelID" id="hotelID" onblur="validateHotelID()"></form:input><form:errors path="hotelID" ></form:errors></td>
...
<td><span id="errorMsg11" style="color:red"></span></td>
    ...
    <input type="submit" value="Add Hotel" name="submit"/><a href=welcome.htm>Back To home</a>
</form:form>
