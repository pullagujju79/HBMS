        ...
        <div class="header-box">
          <div class="inner">
            <ul class="nav">
              ...
              <li><a href="user/showLogin.htm">Booking</a></li>
...
&nbsp; &nbsp; &nbsp; &nbsp; Rooms:&nbsp;
        ...
        <!-- box end -->
		<div class="box maxheight">
		<img class="img-indent png" alt="" src="resource/images/Hotel-room-renaissance-columbus-ohio.jpg" width="270p" height="412p" />
		</div>
      </div>
      <div class="content">
        <div class="indent">
          <h2>Paradise is happy to welcome you!</h2>
          <img class="img-indent png" alt="" src="resource/images/1page-img1.png" />
          ...
          <div class="wrapper line-ver">
            <div class="col-1">
              ...
              <ul>
                ...
                <li>International Food service</li>
                <li>FREE drinks and beverages in rooms</li>
                <li>Exclusive souvenirs</li>
              </ul>
                      <!-- <div class="button"><span><span><a href="login.jsp">Order Now!</a></span></span></div>-->
            </div>
            <div class="col-2">
              <h3>Location</h3>
              <p>We are located in the center surrounded by malls and boutiques.</p>
